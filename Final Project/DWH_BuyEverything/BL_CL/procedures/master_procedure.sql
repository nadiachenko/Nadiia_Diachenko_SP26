...
EXCEPTION WHEN OTHERS THEN
    CALL bl_cl.p_log('load_bl_3nf', 'ERROR', NULL, SQLERRM, SQLSTATE);
    RAISE;
END;
$$;
...
EXCEPTION WHEN OTHERS THEN
    CALL bl_cl.p_log('load_bl_dm', 'ERROR', NULL, SQLERRM, SQLSTATE);
    RAISE;
END;
$$;
...
EXCEPTION WHEN OTHERS THEN
    CALL bl_cl.p_log('load_all', 'ERROR', NULL, SQLERRM, SQLSTATE);
    RAISE;
END;
$$;